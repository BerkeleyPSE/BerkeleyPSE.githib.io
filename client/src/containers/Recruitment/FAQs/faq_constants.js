const FAQ_INFO = [
  ...
  {
    question: "Why should I join PSE?",
    answer: ""
  },
  {
    question: "What do you look for in recruits?",
    answer: ""
  },
  {
    question: "Are all recruitment events mandatory?",
    answer:
      "You must attend at least one of the three recruitment events (Meet the Chapter, Social Mixer, Case Workshop) to be considered for an interview. The greater the number of events you attend, the more chances you have to meet the brothers and vice versa, and the better we will be able to learn about you. If you cannot attend an event, please reach out to our recruitment chairs Abhi and Jacqueline at berkeleypse.recruitment@gmail.com."
  },
  {
  ...
  },
  {
    ...
    answer:
      "The time commitment for a prospective member (PM) generally ranges from 3-10 hours per week outside of a weekly 2-hour PM training on Monday nights."
  },
  {
    question: "Will I be hazed as a prospective member?",
    answer:
      "Absolutely not. PSE respects the time and health of its prospective members. We actively encourage our PMs to partake in other enjoyable activities. They should not sacrifice their mental health, physical health, or academic lives for PSE."
  },
  {
